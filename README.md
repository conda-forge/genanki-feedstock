...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/genanki-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12237&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/genanki-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `genanki` can be installed with:

```
conda install genanki
```

It is possible to list all of the versions of `genanki` available on your platform with:
